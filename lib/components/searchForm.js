...
var SearchForm = function (_Component) {
    ...
    function SearchForm(props) {
        ...
        _this._updateSchemaConfigurations = function (toBeShownFilters, visibilityConfig, changedFormFields) {
        ...
        _this._submitSearchingData = function (_ref) {
            var formData = _ref.formData,
                options = _objectWithoutProperties(_ref, ['formData']);
            ...
            if (changedFormFields) {
                ...
                if (message.operation === SearchForm.RESET_FORM_CONFIGURATION) {
                    ...
                    schemaConfiguration = _this._updateSchemaConfigurations(message.filtersData, message.filtersVisibility, changedFormFields);
                }
