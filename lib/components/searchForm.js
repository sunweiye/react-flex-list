...
var SearchForm = function (_Component) {
    ...
    function SearchForm(props) {
        ...
        _this._updateSchemaConfigurations = function (toBeShownFilters, visibilityConfig) {
        ...
        _this._shouldSubmitData = function (search, filters) {
            var _this$state$formData = _this.state.formData,
                _q = _this$state$formData._q,
                lastFilters = _objectWithoutProperties(_this$state$formData, ['_q']),
                lastSearchInput = _this.state.formData['_q'] + '';
        ...
        _this._submitSearchingData = function (_ref) {
            ...
            if (_this._shouldSubmitData(formData._q, filters)) {
                var message = _this.props.onSearch(formData),
                    schemaConfiguration = {};
                ...
                if (message.operation === SearchForm.RESET_FORM_CONFIGURATION) {
                    ...
                    schemaConfiguration = _this._updateSchemaConfigurations(message.filtersData, message.filtersVisibility);
                }
    ...
    _createClass(SearchForm, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                formProps = _objectWithoutProperties(_props, ['onSubmit', 'onChange', 'onSearch', 'searchOnChange', 'schema', 'uiSchema', 'formData']);
