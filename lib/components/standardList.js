  ...
  function StandardList(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "_preProcess", function () {
      var _this$props = _this.props,
          ...
          containerProps = (0, _objectWithoutProperties2.default)(_this$props, ["data", "itemPreprocessor", "itemRender", "searchForm", "indexFields", "textSearchFieldName", "sortFieldName", "searchTextInFields", "filtersFieldsMap", "pageSize", "paginationSettings", "listContainerSettings", "afterInitialized", "beforeSearch", "afterSearch", "resultInfoRender", "initializationRender", "afterPageChanged", "renderOrder"]),
          processors = [_preProcessors.generateDocIdByTime].concat((0, _toConsumableArray2.default)(typeof itemPreprocessor === 'function' ? [itemPreprocessor] : [])); // Make sure that the data and itemRender props don't exist in the list container props
