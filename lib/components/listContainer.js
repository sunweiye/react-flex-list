...
var ListContainer = function ListContainer(props) {
  var listTagName = props.listTagName,
      ...
      listContainerProps = (0, _objectWithoutProperties2.default)(props, ["listTagName", "data", "itemRender", "emptyListContent", "children", "childrenBeforeList", "listClassName"]),
      ListTag = listTagName,
  ...
  return _react.default.createElement("div", listContainerProps, childrenBeforeList ? [childrenContent, listContent] : [listContent, childrenContent]);
};
