    ...
    _createClass(FlexList, [{
        ...
        value: function _renderPagination() {
            if (this.state.pageCount > 1) {
                return _react2.default.createElement(_reactPaginate2.default, { previousLabel: "previous",
                    nextLabel: "next",
        ...
        value: function render() {
            var _props = this.props,
                ...
                containerProps = _objectWithoutProperties(_props, ['listData', 'renderItem', 'searchForm', 'searchTextFields', 'pageSize', 'listContainerSettings', 'onListRender']);
